...
namespace Strategy_Pattern_Using_different_shipping_providers
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var shippingProvider = Convert.ToInt32(Console.ReadLine().Trim());
            ...
            var invoiceOption = Convert.ToInt32(Console.ReadLine());
            #endregion
            ...
            var order = new Order
            {
                ...
                ShippingStrategy = GetShippingStrategyFor(shippingProvider)
            };
        ...
        private static IShippingStrategy GetShippingStrategyFor(int shippingProvider)
        {
            switch (shippingProvider)
            {
                case 1: return new SwedishPostalServiceShippingStrategy();
                case 2: return new DhlShippingStretegy();
                case 3: return new USShippingStrategy();
